        ...
        {categories.map((cat) => {
          ...
          return (
            <li key={cat.id}>
              ...
              >
                <span className={`flex h-7 w-7 items-center justify-center rounded-lg text-sm transition-all ${
                  isActive
                ...
                <span className="flex-1 text-xs font-medium sm:text-sm">{cat.label}</span>
                {count > 0 && (
